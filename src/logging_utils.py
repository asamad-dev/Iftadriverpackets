...
def init_file_logging(
    log_name: str = "driver_packet", log_subdir: str = "temp"
) -> logging.Logger:
    """
    ...
    try:
        ...
        if config.LOG_DAILY_ROTATION:
            ...
            daily_handler.suffix = (
                "%Y-%m-%d"  # Backup files: driver_packet_daily.log.2025-10-02
            )
...
def setup_logging(
    log_name: str = "driver_packet",
    log_subdir: str = None,
    redirect_streams: bool = None,
    override_print: bool = None,
) -> logging.Logger:
    """
